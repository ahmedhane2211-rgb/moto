...
function CarSales() {
  ...
  const columns = [
    ...
    { header: t("discount_value"), accessor: "discount" },
  ...
  return (
    <>
    <Seo title={t("seo.sale_title")} description={t("seo.sale_description")}/>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <MyInput
                  ...
                  readOnly
                  className="bg-light"
                  error={errors.remaining?.[0] || errors.remaining_amount?.[0]}
                />
              </div>
            </div>
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <MyInput
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, license_fees: e.target.value })
                    }
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <MyInput
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, bank_amount: e.target.value })
                    }
        ...
        {selectedSale && (
          <div className="row p-3 vsc" style={{ borderRadius: "10px" }}>
            ...
            <div className="col-md-6 mb-3">
              ...
              <p className="border-bottom pb-2">{selectedSale.branch?.name}</p>
            </div>
            ...
            <div className="col-md-4 mb-3">
              ...
              <p className="border-bottom pb-2">{selectedSale.discount}</p>
            </div>
            <div className="col-md-4 mb-3">
            ...
            <div className="col-md-4 mb-3">
              ...
              <p className="border-bottom pb-2">{selectedSale.license_fees}</p>
            </div>
            <div className="col-md-4 mb-3">
            ...
            {selectedSale.bank && (
              <>
                ...
                <div className="col-md-6 mb-3">
                  <label className="fw-bold">{t("purchase_order_date")}:</label>
                  <p className="border-bottom pb-2">
            ...
            <div className="col-md-12">
              ...
              <p className="border-bottom pb-2">{selectedSale.notes || "-"}</p>
            </div>
            {/* Sale Clauses */}
